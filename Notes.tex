...
\affil[3]{Department of Statistical Sciences, Bologna}
...
\begin{enumerate}[label*=\arabic*.]
	...
	\delta_{1g}^{\left(0\right)} &\sim \operatorname{Ga}\left(\alpha_1,\beta_1\right),\quad\delta_{hg}^{\left(0\right)} \sim \operatorname{Ga}\left(\alpha_2,\beta_2\right),\quad h\geq 2\nonumber\\
