...
\mathrm{P}\left(\psi_j^{-1}\given X,F,\Lambda\right) & \sim \operatorname{Ga}\left(\alpha + \frac{N}{2},\beta_j + \frac{S_j}{2}\right)&\label{eq:18}
\end{flalign}
...
\delta_1 &\sim \operatorname{Ga}\left(\alpha_1,\beta_1\right), \quad\delta_h \sim \operatorname{Ga}\left(\alpha_2,\beta_2\right), \quad h \geq 2\label{eq:23}&
\end{flalign}
...
\end{flalign}
\begin{flalign}
\mathrm{P}\left(\delta_k \given \mbox{---}\right) & \propto \prod_{j=1}^{p}\prod_{k=1}^{q^\star}\operatorname{N}\left(\lambda_{jk}\given 0, \phi_{jk}^{-1}\tau_k^{-1}\right) \times \operatorname{Ga}\left(\delta_k \given \alpha_2, \beta_2\right)\nonumber\\
...
\therefore \mathrm{P}\left(\delta_k\given \mbox{---}\right) &\sim \operatorname{Ga}\left(\alpha_2 + \frac{p}{2}\left(q^\star - k + 1\right),\beta_2 +\frac{1}{2}\sum_{h=k}^{q^\star}\tau_h^{\left(k\right)}\sum_{j=1}^p\lambda_{jh}^2\phi_{jh}\right)\label{eq:29}
\end{flalign}
...
\begin{enumerate}[label*=\arabic*.]
	...
	\underline{\Lambda}_{jg}^{\left(0\right)} &\sim\operatorname{MVN}_{q_g^\star}\left(\underline{0},\Sigma_{\lambda}\right)~\quad\hspace{1.5mm}\forall~j = 1,\ldots,p&\nonumber\\
	\psi_{jg}^{-1^{\left(0\right)}} &\sim \operatorname{Ga}\left(\alpha,\beta_j\right)~\quad\quad\hspace{5mm}\forall~j = 1,\ldots,p&\nonumber\\
	\phi_{jkg}^{\left(0\right)} &\sim \operatorname{Ga}\left(\nu + 1,\nu\right)~\qquad\forall~j = 1,\ldots,p\quad\mbox{and}\quad k=1,\ldots,q_g^\star\nonumber\\
	\delta_{1g}^{\left(0\right)} &\sim \operatorname{Ga}\left(\alpha_1,\beta_1\right),\hspace{3mm}\delta_{hg}^{\left(0\right)} \sim \operatorname{Ga}\left(\alpha_2,\beta_2\right),\quad h\geq 2\nonumber\\
