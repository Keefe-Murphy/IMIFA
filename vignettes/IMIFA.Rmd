...
Finally, we can visualise the N * N similarity matrix by supplying `g=4` when `plot.meth="zlabels"`. Had we not specified `g`, the function would cycle through the available plots.
```{r}
