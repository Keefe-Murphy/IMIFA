...
To examine the factor score parameters, where `all` below refers to trace, density, posterior mean, and ACF plots, and `mat=TRUE` means, in this case, to all plot all observations simultaneously (for a given factor, say the 1st), we can type

```{r}
plot(resIMIFA, plot.meth="all", param="scores", mat=TRUE, fac=1)
```
