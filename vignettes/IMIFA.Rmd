...
Model-specific diagnostic tools are also provided, as well as many extensive options for plotting results, conducting posterior inference on parameters of interest, and quantifying uncertainty. The functions are typically verbose, offering plenty of messages and warnings to the user where appropriate. Please see [Murphy et al. (2019)](https://arxiv.org/abs/1701.07010v5) for more info.
...
Murphy, K., Viroli, C., and Gormley, I. C. (2019). Infinite Mixtures of Infinite Factor Analysers. _To appear_. Pre-print available at [arXiv:1701.07010v5](https://arxiv.org/abs/1701.07010v5).
