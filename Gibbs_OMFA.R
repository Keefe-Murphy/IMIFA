  ...
  # Iterate
    ...
    # Scores & Loadings
      ...
      if(Q0) {
        ...
        lmat       <- array(unlist(lapply(Gseq, function(g) if(nn0[g]) matrix(unlist(lapply(Pseq, function(j) sim.load(l.sigma=l.sigma, Q=Q, P=P, c.data=c.data[[g]][,j], f=f.tmp[[g]], Q1=Q1, 
